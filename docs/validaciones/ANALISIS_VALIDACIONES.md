...
- **Export del seller** = **solo Owner: Seller** (completitud de dato + imágenes). **Sin material de referencia** (nada de guías completas): principio *"solo le decimos el cambio a realizar"*. La **regla concreta** que incumple va **embebida inline** junto a cada corrección (p. ej. *"faltan imágenes → mínimo 4, fondo #FFFFFF, 1500×1500"*, *"estructura de título: [Marca]+[Modelo]+[Característica]+[Color]"*). Las guías completas se quedan **internas** (módulo de Guías del toolkit).
