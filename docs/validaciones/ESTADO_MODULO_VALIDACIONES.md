...
- ⚠️ **Contenido real de los exports — A MEDIAS (no cerrado).** Es el pendiente de prototipo más claro que **depende solo de nosotros**.
  ...
  - Es un **primer pase**: un seller dummy, generación por html2canvas frágil, diseño sin rematar.
  - **Falta**: (1) **verificar el PDF en navegador de verdad** (headless), (2) según resultado, afinar html2pdf o cambiar de enfoque (print-to-PDF con hoja de estilo / jsPDF con texto seleccionable), (3) **pulir** diseño y datos.
