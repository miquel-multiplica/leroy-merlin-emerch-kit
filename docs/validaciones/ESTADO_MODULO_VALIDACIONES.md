...
- ⚠️ **Contenido real de los exports — PDF del seller rehecho (2026-09-21), pendiente de validar en navegador.**
  ...
  - **PDF del seller — rediseñado de cero contra la guía eMerch**, que es la referencia del "debe ser":
    ...
    - **Vínculo explícito con el CSV**: el documento lo **nombra** (`informe-seller-<slug>.csv`) y comparte **ID de auditoría** con él, para que sean un par identificable.
